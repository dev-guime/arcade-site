      ...
      <header className="relative z-10 text-center pt-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8 flex justify-center">
            <img src="/lovable-uploads/04d45766-a7e4-47c9-8c45-1e09419819f5.png" alt="Arcade Games Logo" className="w-120 h-120 md:w-40 md:h-40 floating-logo object-cover" />
          </div>
          ...
          <p className="text-xl text-gray-300 mb-12 font-light tracking-wide md:text-xl">
