          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="highlight" className="text-slate-300">Destacar produto</Label>
                </div>

                {formData.highlight && (
                  <div>
                    <Label htmlFor="highlight_text" className="text-slate-300">Destacar como:</Label>
                    <Input
                      id="highlight_text"
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                {mainImage && (
                  <div className="mt-2">
                    <img src={mainImage} alt="Preview" className="w-24 h-24 object-cover rounded border border-slate-600" />
                  </div>
                )}
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <Label className="text-slate-300">Imagens Secundárias (Carrossel)</Label>
                  <Button
                    type="button"
